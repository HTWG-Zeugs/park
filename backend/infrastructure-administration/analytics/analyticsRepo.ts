...
export class AnalyticsRepo {
  ...
  async createParkingDurationRecord(garageId: string, record: NumberRecord): Promise<void> {
    await this.createRecord(this.parkingDurationPrefix + garageId, record);
  }

  async getParkingDurationRecords(garageId: string, from: Date, to: Date): Promise<NumberRecord[]> {
    const querySnapshot = await this.queryDocInRange(
  ...
  async createChargingStatusRecord(garageId: string, status: OccupancyRecord): Promise<void> {
    await this.createRecord(this.chargingStatusPrefix + garageId, status);
  }

  async getChargingStatusRecord(garageId: string, timestamp: Date): Promise<OccupancyRecord> {
    const querySnapshot = await this.queryDocForTimestamp(
  ...
  async getChargingStatusRecords(garageId: string, from: Date, to: Date): Promise<OccupancyRecord[]> {
    const querySnapshot = await this.queryDocInRange(
      this.chargingStatusPrefix + garageId, 
      from, 
      to
  ...
  async createPowerConsumptionRecord(garageId: string, record: NumberRecord): Promise<void> {
    await this.createRecord(this.powerConsumptionPrefix + garageId, record);
  }

  async getPowerConsumptionRecords(garageId: string, from: Date, to: Date): Promise<NumberRecord[]> {
    const querySnapshot = await this.queryDocInRange(
  ...
  async createTurnoverRecord(garageId: string, record: NumberRecord): Promise<void> {
    await this.createRecord(this.turnoverPrefix + garageId, record);
  }

  async getTurnoverRecords(garageId: string, from: Date, to: Date): Promise<NumberRecord[]> {
    const querySnapshot = await this.queryDocInRange(
  ...
  async createDefectStatusRecord(garageId: string, record: DefectStatusRecord): Promise<void> {
    await this.createRecord(this.defectStatusPrefix + garageId, record);
  }

  async getDefectStatusRecord(garageId: string, timestamp: Date): Promise<DefectStatusRecord> {
    const querySnapshot = await this.queryDocForTimestamp(
  ...
  async getDefectStatusRecords(garageId: string, from: Date, to: Date): Promise<DefectStatusRecord[]> {
    const querySnapshot = await this.queryDocInRange(
      this.defectStatusPrefix + garageId, 
      from, 
      to
  ...
  private async queryDocForTimestamp(collection: string, timestamp: Date): Promise<FirebaseFirestore.QuerySnapshot<any>> {
  ...
  private async queryDocInRange(collection: string, from: Date, to: Date): Promise<FirebaseFirestore.QuerySnapshot<any>> {
