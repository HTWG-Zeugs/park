...
router.delete("/:id", validateFirebaseIdToken, (req: Request, res: Response) => {
  defectController.deleteDefect(req, res);
});

router.get('/signedUrl/:image', validateFirebaseIdToken, async (req: Request, res: Response) => {
  await defectController.getSignedUrlForImage(req, res);
});

router.get('/signedUploadUrl/:image', validateFirebaseIdToken, async (req: Request, res: Response) => {
